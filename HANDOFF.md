...
- **SEO infra:** robots.txt, sitemap.xml (**103 URLs** — every indexable page; privacy/terms/method are noindex and excluded), IndexNow key file + submitter (see §10).
