...
SERVICES = [
    ...
    },
    {
        ...
        "title": "Real Estate SEO & Neighborhood Pages for Agents | CitedRealty",
        "desc": "Real estate SEO for agents: technical foundations plus dedicated neighborhood pages that win the local searches Zillow underserves — and give AI a citable local expert.",
        "tag": "Foundations",
    ...
    },
    {
        ...
        "cite": "[6]",
        "nav": "Social Media",
        "title": "Real Estate Social Media Marketing for Agents | CitedRealty",
        "desc": "Real estate social media marketing for agents — from strategy, calendars, and coaching to fully done-for-you management. Presence that makes the AI recommendation feel inevitable.",
        "tag": "Presence",
